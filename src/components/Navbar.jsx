        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button onClick={() => go('#home')} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M3 9L7.5 4.5L12 9L16.5 4.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M3 13.5L7.5 9L12 13.5" stroke="rgba(255,255,255,0.6)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 19, color: '#0f172a', letterSpacing: '-0.3px' }}>
              Nexora<span style={{ color: '#2563eb' }}>.</span>
            </span>
          </button>
          ...
          <div style={{ display: 'flex', gap: 2, alignItems: 'center' }} className="desktop-nav">
            ...
            <button onClick={() => go('#contact')} style={{
              marginLeft: 12, padding: '9px 22px', borderRadius: 8,
          ...
          <button onClick={() => setMenuOpen(o => !o)} className="hamburger" style={{
            ...
            borderRadius: 8, padding: '7px 10px', cursor: 'pointer', color: '#334155', fontSize: 18,
          }}>{menuOpen ? '✕' : '☰'}</button>
        </div>
          ...
          <div style={{
            ...
            {NAV_LINKS.map(l => (
              <button key={l.href} onClick={() => go(l.href)} style={{
                ...
                background: 'none', border: 'none', cursor: 'pointer',
                color: '#334155', fontFamily: 'var(--font-body)',
