...
const SERVICES = [
  ...
  },
  {
    ...
    bg: "#ecfeff",
    image:
      "https://images.unsplash.com/photo-1553484771-371a605b060b?w=500&q=80",
  },
  {
    icon: "✉️",
...
export default function Services() {
  ...
  return (
    <section
      id="services"
      style={{ padding: "100px 0", background: "#f8f9fc" }}
    >
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 32px" }}>
        <div ref={ref} style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          >
            A complete range of digital marketing services to help your business
            grow and get found online.
          </p>
        </div>
        <div
          style={{
